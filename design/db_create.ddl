CREATE TABLE academic_term (id int(10) NOT NULL AUTO_INCREMENT, yearIdentifier varchar(100) NOT NULL, termIdentifier varchar(100), name varchar(1000) CHARACTER SET utf8, `start` date NOT NULL, `end` date NOT NULL, PRIMARY KEY (id));
CREATE TABLE academic_term_name (academic_term int(10) NOT NULL, name varchar(1000) CHARACTER SET utf8, language int(10) NOT NULL);
CREATE TABLE address (id int(10) NOT NULL AUTO_INCREMENT, recipient varchar(1000) CHARACTER SET utf8, addressLines varchar(1000) CHARACTER SET utf8, buildingNumber varchar(100) CHARACTER SET utf8, buildingName varchar(1000) CHARACTER SET utf8, streetName varchar(1000) CHARACTER SET utf8, unit varchar(100) CHARACTER SET utf8, floor varchar(100) CHARACTER SET utf8, pobox varchar(1000) CHARACTER SET utf8, deliveryPoint varchar(1000) CHARACTER SET utf8, postalCode varchar(100) CHARACTER SET utf8, locality varchar(1000) CHARACTER SET utf8, region varchar(1000) CHARACTER SET utf8, country int(10), PRIMARY KEY (id));
...
CREATE TABLE contact_description (contact int(10) NOT NULL, text text NOT NULL CHARACTER SET utf8, language int(10));
...
CREATE TABLE contact_name (contact int(10) NOT NULL, name varchar(1000) NOT NULL CHARACTER SET utf8, language int(10), type varchar(100) NOT NULL CHARACTER SET utf8);
CREATE TABLE contact_phone (contact int(10) NOT NULL, phoneNumber varchar(100));
CREATE TABLE country (id int(10) NOT NULL AUTO_INCREMENT, code varchar(100) NOT NULL, name_en varchar(1000), name_cz varchar(1000) CHARACTER SET utf8, PRIMARY KEY (id));
CREATE TABLE credit (opportunity_instance int(10) NOT NULL, scheme varchar(1000) NOT NULL CHARACTER SET utf8, level varchar(64), value decimal(10, 2) NOT NULL);
CREATE TABLE grading_scheme (opportunity_instance int(10) NOT NULL, label varchar(1000) CHARACTER SET utf8, description varchar(4000) CHARACTER SET utf8, language int(10));
CREATE TABLE institution (id int(10) NOT NULL AUTO_INCREMENT, identifier varchar(64) NOT NULL UNIQUE, abbreviation varchar(20) CHARACTER SET utf8, logo_url varchar(1000), location_address int(10), mailing_address int(10), PRIMARY KEY (id));
CREATE TABLE institution_contact (institution int(10) NOT NULL, contact int(10) NOT NULL, PRIMARY KEY (institution, contact));
CREATE TABLE institution_factsheet (institution int(10) NOT NULL, name varchar(1000) CHARACTER SET utf8, url varchar(1000) NOT NULL, language int(10));
CREATE TABLE institution_name (institution int(10) NOT NULL, name varchar(1000) NOT NULL CHARACTER SET utf8, language int(10));
...
CREATE TABLE language (id int(10) NOT NULL AUTO_INCREMENT, abbreviation varchar(10) NOT NULL, name varchar(100) CHARACTER SET utf8, flag_url varchar(1000), PRIMARY KEY (id), UNIQUE INDEX (abbreviation));
...
CREATE TABLE opportunity_description (learning_opportunity int(10) NOT NULL, text text NOT NULL CHARACTER SET utf8, language int(10));
...
CREATE TABLE opportunity_title (learning_opportunity int(10) NOT NULL, title varchar(1000) NOT NULL CHARACTER SET utf8, language int(10));
CREATE TABLE opportunity_type (id int(10) NOT NULL AUTO_INCREMENT, name_en varchar(500) NOT NULL, name_cz varchar(500) CHARACTER SET utf8, PRIMARY KEY (id));
CREATE TABLE opportunity_website (learning_opportunity int(10) NOT NULL, url varchar(1000) NOT NULL, language int(10));
CREATE TABLE result_distribution_category (opportunity_instance int(10) NOT NULL, label varchar(1000) NOT NULL CHARACTER SET utf8, count int(10) NOT NULL, `order` int(10) NOT NULL);
CREATE TABLE result_distribution_description (opportunity_instance int(10) NOT NULL, description text NOT NULL CHARACTER SET utf8, language int(10));
CREATE TABLE unit (id int(10) NOT NULL AUTO_INCREMENT, identifier varchar(64) NOT NULL, institution int(10) NOT NULL, root int(1), code varchar(1000), abbreviation varchar(20) CHARACTER SET utf8, logo_url varchar(1000), parent int(10), location_address int(10), mailing_address int(10), PRIMARY KEY (id));
CREATE TABLE unit_contact (unit int(10) NOT NULL, contact int(10) NOT NULL, PRIMARY KEY (unit, contact));
CREATE TABLE unit_factsheet (unit int(10) NOT NULL, name varchar(1000) CHARACTER SET utf8, url varchar(1000) NOT NULL, language int(10));
CREATE TABLE unit_name (unit int(10) NOT NULL, name varchar(1000) NOT NULL CHARACTER SET utf8, language int(10));
