use utf8;
package StudentPortal::Schema::Result::OpportunityWebsite;
...
=head1 TABLE: C<opportunity_website>

=cut

__PACKAGE__->table("opportunity_website");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ytpgrr35KsLLIuUhoeu9vw
