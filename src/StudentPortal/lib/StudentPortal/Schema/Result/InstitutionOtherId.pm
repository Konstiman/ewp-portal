use utf8;
package StudentPortal::Schema::Result::InstitutionOtherId;
...
=head1 TABLE: C<institution_other_id>

=cut

__PACKAGE__->table("institution_other_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6mX+fXHqesU19oQlZVOBAw
