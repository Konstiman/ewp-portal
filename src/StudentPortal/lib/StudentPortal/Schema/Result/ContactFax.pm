use utf8;
package StudentPortal::Schema::Result::ContactFax;
...
=head1 TABLE: C<contact_fax>

=cut

__PACKAGE__->table("contact_fax");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AhPJPsLE1hQcgkYL//ieZA
