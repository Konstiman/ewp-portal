use utf8;
package StudentPortal::Schema::Result::UnitName;
...
=head1 TABLE: C<unit_name>

=cut

__PACKAGE__->table("unit_name");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DZoafXvFuabX7btQGw9V2Q
