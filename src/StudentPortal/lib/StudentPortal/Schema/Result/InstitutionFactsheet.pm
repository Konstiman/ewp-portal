use utf8;
package StudentPortal::Schema::Result::InstitutionFactsheet;
...
=head1 TABLE: C<institution_factsheet>

=cut

__PACKAGE__->table("institution_factsheet");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I9Lq2n16LlRfSw+J8JIVtA
