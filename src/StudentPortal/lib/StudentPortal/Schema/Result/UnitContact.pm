use utf8;
package StudentPortal::Schema::Result::UnitContact;
...
=head1 TABLE: C<unit_contact>

=cut

__PACKAGE__->table("unit_contact");
...
__PACKAGE__->set_primary_key("unit", "contact");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TsqPGHeDFBYEnj3R3/TkYw
