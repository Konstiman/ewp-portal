use utf8;
package StudentPortal::Schema::Result::InstitutionName;
...
=head1 TABLE: C<institution_name>

=cut

__PACKAGE__->table("institution_name");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:a3uZigeewtWF1HB0b1fHlg
