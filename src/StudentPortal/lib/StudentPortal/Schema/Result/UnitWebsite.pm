use utf8;
package StudentPortal::Schema::Result::UnitWebsite;
...
=head1 TABLE: C<unit_website>

=cut

__PACKAGE__->table("unit_website");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VITQcGNhYTHfxognNi1wUQ
