use utf8;
package StudentPortal::Schema::Result::GradingScheme;
...
=head1 TABLE: C<grading_scheme>

=cut

__PACKAGE__->table("grading_scheme");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XqxA/CwP6s4S0m+NFT1ecA
