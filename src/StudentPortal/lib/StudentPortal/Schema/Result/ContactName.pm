use utf8;
package StudentPortal::Schema::Result::ContactName;
...
=head1 TABLE: C<contact_name>

=cut

__PACKAGE__->table("contact_name");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G3ujjIXF2B6UuDSvfh2C8Q
