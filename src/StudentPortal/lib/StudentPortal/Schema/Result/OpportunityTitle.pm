use utf8;
package StudentPortal::Schema::Result::OpportunityTitle;
...
=head1 TABLE: C<opportunity_title>

=cut

__PACKAGE__->table("opportunity_title");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jdRiV74Ph09TLHcG/HUzAg
